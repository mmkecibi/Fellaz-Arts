          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-7">
                <div class="text">
                  <h1>
                    We Provide <span>Security</span> Services That You Can
                    <span>Trust!</span>
                  </h1>
                  <p>
                  ...
                  <div class="button">
                    <nuxt-link to="/search/agent" class="btn">
                      <i class="fa fa-search"></i> {{ $t("Find An Agent") }}
                    </nuxt-link>
...
export default {
  ...
  mixins: [ToolsjqueryMixin, ToolsmenuNavMixin],
  components: {
    AppTextlockup,
    AppSalesBoxes,
    AppFeaturedProducts
