    ...
    <div class="paper">
      <div class="main-contents">
        ...
        <div class="success-description">
         {{ $t("Hello") }} {{user.firstname  }} {{user.lastname  }}, {{ $t("we have ve received your order. We will send an email when its on the way home") }}. 
        </div>
        <div class="order-details">
          <div class="order-number-label">{{ $t("Order Number") }}</div>
          <div class="order-number">{{getordernumber}}</div>
        </div>
        <div class="order-footer">{{ $t("Thank you") }}!</div>
      </div>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({ 
            ...
            getordernumber: 'orderstore/getordernumber'
        }),
  },
  methods: {
    startInterval() {
...
.paper {
  ...
  margin: 0 12px;
  margin-top: -12px;
  animation: print 1800ms cubic-bezier(0.68, -0.55, 0.265, 0.9) 2;
  -moz-animation: print 1800ms cubic-bezier(0.68, -0.55, 0.265, 0.9) 2;
}
